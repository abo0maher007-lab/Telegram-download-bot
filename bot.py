...
# دالة آمنة لتعديل الرسائل تجنباً لخطأ MessageNotModifiedError
...
# استخراج رابط APKMirror المباشر
...
async def start_handler(event):
    await event.respond("🚀 **مرحباً بك في بوت التنزيل والرفع Pro v5.7**")
...
async def process_download_job(event, url):
    ...
    # استخراج اسم الملف المباشر وتجاهل متغيرات الـ URL
