...
# ----------------------------------------------------
# 🚂 إعداد التسجيل والمحيط - v31.0 Engine
# ----------------------------------------------------
logging.basicConfig(level=logging.INFO, format="%(asctime)s - [%(levelname)s] - %(message)s")
logger = logging.getLogger("UniversalBot_v31_0")
...
app = Client("UniversalDownloaderBot_v31_0", api_id=int(API_ID), api_hash=API_HASH, bot_token=BOT_TOKEN)
...
# ----------------------------------------------------
# 🖼️ أدوات الثمبنيل والمدة وأبعاد الفيديو v31.0
# ----------------------------------------------------
...
async def start_cmd(client: Client, message: Message):
    await message.reply_text(
        "🚀 **أهلاً بك في بوت v31.0 Universal Engine**\n\n"
        "✨ **الجديد في v31.0:**\n"
        "• إصلاح مشغل الفيديو لتفعيل التكبير الكامل للشاشة (Fullscreen) والتشغيل المباشر داخل تليجرام.\n"
        "• تحسين جلب الأبعاد والعرض/الارتفاع تلقائياً لمنع أي أخطاء عرض.\n"
...
# ----------------------------------------------------
# 📩 معالجة الفيديو الموجه والملفات (Stateless Forward Engine v31)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 📩 معالجة الرسائل والروابط ومدخلات القص v31.0
# ----------------------------------------------------
...
if __name__ == "__main__":
    ...
    logger.info("🚀 جاري تشغيل بوت v31.0 Universal Engine (مع إصلاح Fullscreen)...")
    app.run()
