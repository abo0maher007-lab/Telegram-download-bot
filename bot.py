...
# ----------------------------------------------------
# 3. خطاف yt-dlp السريع مع حماية عدم التعليق
# ----------------------------------------------------
...
async def download_yt_dlp_best(url: str, output_path: str, bot, chat_id, message_id, task_id) -> dict:
    ...
    ydl_opts = {
        'format': 'best[ext=mp4]/best',  # اختيار صيغة جاهزة مدمجة فورية لتجنب التعليق عند التجميع
        'outtmpl': output_path,
        'writethumbnail': True,
        'noplaylist': True,
        'quiet': True,
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        "مرحباً بك في بوت التنزيل والرفع المباشر v8.0 🚀\n\n"
        "✨ **المميزات:**\n"
        "• **تنزيل مباشر وسريع مع شريط معلومات حية** بدون تعليق.\n"
        "• **رفع متدرج وشريط حي للرفع** بجميع المعلومات.\n"
...
def main():
    ...
    logging.info("==========================================")
    logging.info("تم التشغيل بنجاح مع إزالة مشكلة التجميد 0.0%!")
    logging.info("==========================================")
