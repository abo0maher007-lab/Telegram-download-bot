...
# ----------------------------------------------------
# 🚂 إعداد التسجيل والمحيط - v58 Engine (Anti-403/429 & Full Browser Impersonation)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 🧠 المحرك الشامل v58 Engine (مع ترويسات متصفح حقيقي ومقابلة الحظر Anti-403/429)
# ----------------------------------------------------
class UniversalEngineV58:
    ...
    def download_indirect_media(self, url: str, target_option: str, task_id: str, status_msg: Message, loop: asyncio.AbstractEventLoop) -> Dict[str, Any]:
        ...
        # تنفيذ معالجة الاستخراج مع نظام إعادة التجريب عند مواجهة خطأ 403 أو 429
        max_dl_retries = 3
            ...
            if now - last_update_time >= 2.0 or current == 0 or current == total:
                ...
                if mode == "time":
                    if total > 0:
                        ...
                        speed_factor = speed
                        text = (
                            f"⚙️ **[v58 Engine - Anti-403/429 Protected]**\n"
                    ...
                    text = (
                        f"⚡ **[v58 Engine - Anti-403/429 Protected]**\n"
                        f"📌 **العملية:** {action_title}\n\n"
                        f"{bar}"
...
async def start_cmd(client: Client, message: Message):
    await message.reply_text(
        "🚀 **أهلاً بك في بوت v58 Universal Downloader & Anti-403/429 Browser Impersonation Engine**\n\n"
        "✨ **تحديثات الإصدار v58 الجديدة:**\n"
        "• 🛡️ **حل مشكلة HTTP Error 403 / 429:** دعم ترويسات متصفحات حقيقية متكاملة (Real Browser Impersonation) لتجنب حظر وتحديد طلبات المنصات.\n"
...
if __name__ == "__main__":
    logger.info("🚀 جاري تشغيل بوت v58 (Anti-403/429 & Real Browser Headers Protected)...")
    app.run()
