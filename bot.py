...
async def start_cmd(client: Client, message: Message):
    await message.reply_text(
        ...
        "• التعرف الذكي على ملفات **MediaFire** وتحديد الإرسال (فيديو/مستند/APK/ZIP).\n"
        "• دعم **Mega.nz**، **Instagram**، **X (Twitter)**، والمزيد.\n"
        "• لوحة التحكم بالقرص المحدثة `/disk`.\n"
        "• نظام إلغاء العمليات الفوري.\n\n"
        "أرسل أي رابط للبدء."
    )
