...
# ----------------------------------------------------
# 🚂 إعداد التسجيل والمحيط - v24.0 Hybrid Engine
# ----------------------------------------------------
    ...
    while task_id not in CANCELLED_TASKS:
        try:
            ...
            if now - last_update_time >= 2.5:
                ...
                text = (
                    f"⚡ **[v24.0 Universal Hybrid Engine]**\n"
...
async def start_cmd(client: Client, message: Message):
    await message.reply_text(
        "🚀 **أهلاً بك في بوت v24.0 Universal Hybrid Engine**\n\n"
        "• دعم تحميل الملفات المباشرة من **MediaFire** و **Mega.nz**.\n"
        "• دعم دمج كوكيز **Instagram** ومنصة **X (Twitter)**.\n"
...
if __name__ == "__main__":
    ...
    logger.info("🚀 جاري تشغيل بوت v24.0 Hybrid Engine...")
    app.run()
