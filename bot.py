...
# ----------------------------------------------------
# 🧠 المحرك الشامل v29.0 (المحدث لحل استخراج الصوت بأعلى جودة)
# ----------------------------------------------------
class UniversalEngineV29:
    ...
    def download_indirect_media(self, url: str, target_option: str, task_id: str, status_msg: Message, loop: asyncio.AbstractEventLoop) -> Dict[str, Any]:
        ...
        if target_option == "mp3":
            # اختيار أفضل مسار صوتي متاح بأعلى Bitrate وتعيين دقة التحويل إلى أقصى حد (0)
        ...
        ydl_opts = {
            ...
            'geo_bypass': True,
            'audioquality': 0,  # الحصول على أقصى ترميز ممكن بدون ضغط متدني
            'http_headers': {
