...
# --- قراءة المتغيرات الحساسة من إعدادات المنصة (Environment Variables) ---
...
# جلسة بدون حفظ ملف لتفادي قفل الجلسات (session lock)
bot = TelegramClient(
    None,
    API_ID,
    API_HASH,
...
# --- رسالة الترحيب والتعريف بعمل البوت ---
...
async def start_handler(event):
    welcome_text = (
        ...
        "• 📱 **التطبيقات:** `APK` (يدعم فك الحماية من موقع **APKMirror** تلقائياً).\n\n"
        "✍️ **كيفية الاستخدام:**\n"
        "قم بنسخ **الرابط المباشر** لأي ملف وأرسله هنا مباشرة في المحادثة، وسيقوم البوت بالباقي مع إظهار شريط نسبة التنزيل والرفع!"
    )
