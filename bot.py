...
# ----------------------------------------------------
# 🚂 إعداد التسجيل والمحيط - v26.0 Ultra Clean Engine
# ----------------------------------------------------
...
# ----------------------------------------------------
# ☁️ محرك Mega.nz المستقر (اعتماد yt-dlp النقي 100%)
# ----------------------------------------------------
def download_mega_file(url: str, task_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        raise Exception(f"تعذر تحميل ملف Mega: {str(e)[:100]}")
...
async def start_cmd(client: Client, message: Message):
    await message.reply_text(
        "🚀 **أهلاً بك في بوت v26.0 Ultra Clean Engine**\n\n"
        "• تم تنظيف ملف المستلزمات تماماً وحل مشكلة الـ Build بشكل قطعي.\n"
        "• تم معالجة التحميل من Mega دون اعتمادات خارج المستودعات.\n\n"
...
if __name__ == "__main__":
    ...
    logger.info("🚀 جاري تشغيل بوت v26.0 Ultra Clean Engine...")
    app.run()
