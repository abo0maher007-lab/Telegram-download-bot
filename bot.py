...
# بيانات الاتصال (قم بتعبئتها أو ضبطها في بيئة العمل)
API_ID = int(os.environ.get("API_ID", "123456"))          # ضع API ID الخاص بك
API_HASH = os.environ.get("API_HASH", "YOUR_API_HASH")   # ضع API HASH الخاص بك
...
# ----------------------------------------------------
# 3. التحميل عبر yt-dlp بشكل آمن ومفصول
# ----------------------------------------------------
...
# ----------------------------------------------------
# 4. أدوات المعالجة الصوتية والمرئية عبر FFmpeg
# ----------------------------------------------------
...
async def start_cmd(client: Client, message: Message):
    ...
    await message.reply_text(
        "مرحباً بك! أرسل رابط الفيديو للتحميل المباشر والرفع السريع بدون تجمد.\n\n"
...
async def process_task(client: Client, message: Message, url: str, is_trim=False, start_sec=0, duration_sec=0):
    ...
    try:
        ...
        # التنزيل بداخل خيط منفصل تماماً
        ...
        # الرفع المباشر مع كولباك متزامن من Pyrogram
