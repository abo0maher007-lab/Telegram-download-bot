...
class UniversalEngineV59:
    ...
    def download_indirect_media(self, url: str, target_option: str, task_id: str, status_msg: Message, loop: asyncio.AbstractEventLoop) -> Dict[str, Any]:
        ...
        # الاستراتيجية الثالثة المعدلة لتجنب RuntimeError وتجميد Event Loop
        try:
...
async def start_cmd(client: Client, message: Message):
    await message.reply_text(
        ...
        "• ⚡ **دالة التحميل الخارقة (Ultra Multi-Tier Downloader):** تدعيم دالة التحميل بـ 3 استراتيجيات متدرجة لتجاوز أخطاء 403 Forbidden و 429 Too Many Requests نهائياً.\n"
