...
# ----------------------------------------------------
# 1. إدارة قاعدة البيانات SQLite (تخزين معلمات الطلبات)
# ----------------------------------------------------
def init_db():
...
# ----------------------------------------------------
# 3. محرك yt-dlp واستخراج الجودات
# ----------------------------------------------------
...
# ----------------------------------------------------
# 4. معالجة الفيديو واستخراج أبعاد الميديا عبر FFmpeg
# ----------------------------------------------------
...
# ----------------------------------------------------
# 5. أوامر تلغرام والمعالجات
# ----------------------------------------------------
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    db_add_user(update.effective_user.id)
    welcome_text = (
        "مرحباً بك في بوت التحميل الشامل الذكي v5.0 🚀\n\n"
        "✨ **أبرز التحديثات:**\n"
        "• **مشغل ميديا كامل:** دعم إرسال الفيديو بخصائص البث لتظهر معابينة التشغيل مباشرة.\n"
        "• **صورة مصغرة تلقائية:** إنشاء وتعيين غلاف المقطع.\n"
        "• **حل مشكلة انتهاء الطلبات:** حفظ قاعدة بيانات الطلبات دائماً.\n"
        "• **اختيار الجودات:** حتى 1080p.\n"
